In **Allenamento_XGBoost.ipynb** è presente tutto ciò che serve per allenare i modelli basati su XGBoost, dove l'input è nella cartella *Data*, mentre l'output è nella cartella *modelli*.
